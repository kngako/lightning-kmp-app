...
class LnurlAuthTest {
    ...
    fun test_default_scheme() {
        ...
        val signedChallenge = ByteVector(Secp256k1.compact2der(Crypto.sign(data = ByteVector32.fromValidHex(auth.k1), privateKey = linkingKey).toByteArray())).toHex()
    ...
    fun legacy_domain_different_keys() {
        ...
        val legacySignedK1 = ByteVector(Secp256k1.compact2der(Crypto.sign(data = ByteVector32.fromValidHex(k1), privateKey = legacyAuthKey).toByteArray())).toHex()
        ...
        val defaultSignedK1 = ByteVector(Secp256k1.compact2der(Crypto.sign(data = ByteVector32.fromValidHex(k1), privateKey = defaultAuthKey).toByteArray())).toHex()
    ...
    fun standard_domain_same_key() {
        ...
        val defaultNewSignedK1 = ByteVector(Secp256k1.compact2der(Crypto.sign(data = ByteVector32.fromValidHex(k1), privateKey = defaultNewAuthKey).toByteArray())).toHex()
