    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val shouldWeWaitLong: Boolean = when {
            ...
            walletId == null -> {
                ...
                when (val result = SeedManager.loadAndDecrypt(
                    ...
                    is DecryptSeedResult.Failure -> {
                        ...
                        serviceScope.launch {
                            val walletMetadataMap = (application as LightningApplication).getGlobalPrefs().getAvailableWalletsMeta.first()
...
//    }
    ...
    companion object {
        const val EXTRA_REASON = "fr.acinq.phoenix.android.services.FCM_MESSAGE.REASON"
        const val EXTRA_NODE_ID_HASH = "fr.acinq.phoenix.android.services.FCM_MESSAGE.NODE_ID_HASH"
    }
}