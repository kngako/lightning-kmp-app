...
class InternalPrefs(private val internalData: DataStore<Preferences>) {
    private companion object {
        ...
        val CHANNELS_WATCHER_OUTCOME = stringPreferencesKey("CHANNELS_WATCHER_RESULT")
    ...
    val getChannelsWatcherOutcome: Flow<ChannelsWatcherOutcome?> = safeData.map {
    ...
    suspend fun saveChannelsWatcherOutcome(channelsWatcherOutcome: ChannelsWatcherOutcome) = internalData.edit {
        it[CHANNELS_WATCHER_OUTCOME] = json.encodeToString(channelsWatcherOutcome)
    }
