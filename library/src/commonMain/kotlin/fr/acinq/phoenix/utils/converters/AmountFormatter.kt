...
//   TODO: private fun getCoinFormat(unit: BitcoinUnit, withMillis: Boolean) = when {
...
//      TODO:  val df = if (limitDecimal) DecimalFormat("0.00") else DecimalFormat("0.########")
//        df.format(this)
    } ?: ""
